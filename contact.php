		...
		<div class="container">
			...
			<div class="mail-grids">
				...
				<div class="col-md-6 mail-right wow fadeInRight animated" data-wow-delay=".5s">
					<h4>ارسال پیام</h4>
					<p>در اسرع وقت به تمامی پیام ها پاسخ داده می شود </p>
					<form method="post">
						<input type="text" placeholder="نام" name="frm[name]" required=" ">
						<input type="email" placeholder="ایمیل"  name="frm[email]" required=" ">
						<div class="clearfix"> </div>
						<input type="text" placeholder="موضوع"  name="frm[subject]" required=" ">
						<textarea placeholder="
نوع متن خود را در اینجا ...."   name="frm[text]" required=" "></textarea>
