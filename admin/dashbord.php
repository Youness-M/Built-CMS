            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=product&p=list">لیست دسته بندی </a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=products&p=list">لیست محصولات</a></li>
                            <li><a class="" href="dashbord.php?m=products&p=add">افزودن محصول جدید</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=newscategory&p=list">لیست دسته بندی </a></li>
                            <li><a class="" href="dashbord.php?m=newscategory&p=add">افزودن دسته بندی جدید</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=contact&p=list">لیست پیام ها</a></li>
                            <li><a class="" href="dashbord.php?m=contact&p=add">پاسخ به پیام ها</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=settings&p=edit">لیست تنظیمات</a></li>
                        </ul>
                    </li>
