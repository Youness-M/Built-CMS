        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">توضیخات خبر</label>
                        <textarea id="editor1" name="frm[text]" class="form-control ckeditor" rows="8" placeholder="توضیحات مربوط به خبر"></textarea>
                    </div>
                    <script>
                        CKEDITOR.replace( 'editor1' );
                    </script>
                    <div class="form-group">
                        <label for="exampleInputPassword1">گروه مربوط به خبر</label>
                        <select class="form-control input-lg m-bot15" name="frm[procat]">

                            <?php
                            $data_subnews=subnews();
                            foreach ($data_subnews as $val) {
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">آپلود عکس خبر </label>
